        ...
        <div className="dashboard-page">
            ...
            <div className="page-intro">
                <div>
                    ...
                    <p>Operational metrics calculated from persisted ORYN commerce data.</p>
                </div>
                <button className="primary-btn" onClick={() => navigate('/products/new')}>
            ...
            {/* Dashboard Grid - Health & Top Products */}
                ...
                <article className="panel activity-panel">
                    ...
                    <div className="health-grid">
                        <button onClick={() => navigate('/orders')}>
                            ...
                            <strong>{loading ? '—' : data?.pendingOrders ?? 0}</strong>
                            <small>Needs fulfillment attention</small>
                        </button>
                        <button onClick={() => navigate('/inventory')}>
                            <span>Low stock variants</span>
                            <strong>{loading ? '—' : data?.lowStock ?? 0}</strong>
            ...
            <section className="panel table-panel">
                <div className="panel-head">
                    <div>
                        <span className="panel-kicker">Commerce</span>
                        <h3>Recent orders</h3>
                    </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            {(data?.recentOrders ?? []).map((order: any) => (
                                ...
                                >
                                    <td className="mono">{order.id.slice(0, 10).toUpperCase()}</td>
                                    <td>
