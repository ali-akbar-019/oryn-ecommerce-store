...
export type ApiWishlist = { items: { id: string; productId: string; product: ApiProduct }[] };

export function useWishlist() { return useQuery({ queryKey: ['wishlist'], queryFn: () => api.get<ApiWishlist>('/wishlist') }); }
