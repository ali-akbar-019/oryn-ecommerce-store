    ...
    <View style={styles.container}>
      ...
      <KeyboardAvoidingScrollView>
        <View style={styles.content}>
          <Text style={styles.eyebrow}>{product.category.name.toUpperCase()}</Text>
            ...
            {[1, 2, 3, 4, 5].map((v) => (
              ...
              >
                <Star
                  size={30}
                  color={colors.text}
                  fill={v <= rating ? colors.text : 'transparent'}
                  strokeWidth={1.5}
                />
              </Pressable>
            ))}
          ...
          <View style={styles.form}>
            ...
            <Input
              ...
              placeholder="Tell other customers about fit, quality and how you use it."
              value={body}
          ...
          <Text style={styles.note}>
            Reviews are available after a delivered purchase and are moderated before publication.
          </Text>
