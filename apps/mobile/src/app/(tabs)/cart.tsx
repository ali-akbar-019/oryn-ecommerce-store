...
export default function CartScreen() {
    ...
    return (
      <View style={[styles.empty, { paddingTop: insets.top + spacing.xxl }]}>
        ...
        <Text style={styles.emptyCopy}>
          Save something you love, then come back when you're ready.
        </Text>
        <Button
  ...
  return (
    ...
    >
            ...
            <View style={styles.itemInfo}>
              <View style={styles.itemTop}>
                <View style={styles.nameWrap}>
                  ...
                  <Text style={styles.meta}>
                    {[item.color, item.size].filter(Boolean).join(' · ') || 'Selected piece'}
                  </Text>
                </View>
              ...
              <View style={styles.itemBottom}>
                ...
                <View style={styles.stepper}>
                  <Pressable
                    onPress={() => update(item.key, item.quantity - 1)}
                    style={styles.step}
                  >
      ...
      <Button
        label={loading ? 'Updating…' : 'Continue to checkout'}
        disabled={loading}
